...
object Utils {
    ...
    fun makeWindowParams(
        ...
        layoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE or
            WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED // POLISH: enables GPU shadow rendering for elevation
        // minSdk 30 (Android 11) — TYPE_APPLICATION_OVERLAY always safe
        layoutParams.type = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY
        layoutParams.width = displayWidth.coerceAtMost(width)
        layoutParams.height = displayHeight.coerceAtMost(height)
        // Android 16 (API 35+): overlay windows need explicit touch permission
        // FLAG_NOT_TOUCH_MODAL lets touches pass through to system beneath
